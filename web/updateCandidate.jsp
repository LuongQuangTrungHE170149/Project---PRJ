    ...
    <body>
        ...
        <div class="content">
            ...
            <form action="UpdateCandidateServlet" method="post">
                ...
                <label>Name:</label>
                <input type="text" name="name" value="${candidate.name}" required><br>
                <label>Address:</label>
                <input type="text" name="address" value="${candidate.address}" ><br>
                <label>Phone Number:</label>
                <input type="text" name="phoneNumber" value="${candidate.phoneNumber}" required pattern="[0-9]{10}" title="Phone number must be 10 digits"><br>
                <label>Email:</label>
                <input type="email" name="email" value="${candidate.email}" required><br>
