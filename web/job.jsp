...
<html>
    ...
    <body>
        ...
        <div class="content">
            <h2>Jobs</h2>
            <form action="SearchJobServlet" method="get">
                <input type="text" name="searchValue" placeholder="Search jobs...">
            ...
            <table border="1">        
                ...
                <c:forEach items="${jobs}" var="job">
                    <tr>
                        ...
                        <!-- Hiển thị nút bấm add, edit, delete -->
                        <td>
                            <a href="UpdateJobServlet?id=${job.getId()}">Edit</a> | 
                            <a href="DeleteJobServlet?id=${job.getId()}">Delete</a> 
                        </td>
                        <% } %>
            ...
            <% if (isManager) { %>
            <!-- Hiển thị nút bấm add, edit, delete -->
            <a href="AddJobServlet" class="add-button">Add New Job</a>
            <% } %>
