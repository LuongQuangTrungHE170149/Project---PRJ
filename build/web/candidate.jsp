...
<html>
    ...
    <body>
        ...
        <div class="content">
            <h2>Candidates</h2>
            <form action="SearchCandidateServlet" method="get">
                <input type="text" name="searchValue" placeholder="Search candidates...">
            ...
            <table border="1">        
                ...
                <c:forEach items="${candidates}" var="candidate">
                    <tr>
                        ...
                        <!-- Hiển thị nút bấm add, edit, delete -->
                        <td>
                            <a href="UpdateCandidateServlet?id=${candidate.id}">Edit</a> | 
                            <a href="DeleteCandidateServlet?id=${candidate.id}">Delete</a>
                        </td>
                        <% } %>
            ...
            <% if (isManager) { %>
            <!-- Hiển thị nút bấm add, edit, delete -->
            <a href="addCandidate.jsp" class="add-button">Add New Candidate</a>
            <% } %>
