...
<body>
    ...
    <form action="UpdateJobServlet" method="post">
        ...
        <textarea name="description" required>${job.getDescription()}</textarea><br>
        <label>Requirements:</label>
        <textarea name="requirements" required>${job.getRequirements()}</textarea><br>
        <label>Posting Date:</label>
        <input type="date" name="postingDate" value="${job.getPostingDate()}" required><br>
